...
export const palettes = {
  light: {
    ...
    tones: {
      ...
      purple: { base: '#4F46E5', emphasis: '#4236C2', onBase: '#FFFFFF', surface: '#E0E7FF', onSurface: '#312E81', border: '#B3BCFF' },
      blue: { base: '#2563EB', emphasis: '#1E46D6', onBase: '#FFFFFF', surface: '#DBEAFE', onSurface: '#1E3A8A', border: '#94BFFF' },
      pink: { base: '#C026D3', emphasis: '#A21CAF', onBase: '#FFFFFF', surface: '#F5E1FA', onSurface: '#7A1A99', border: '#E2B7F2' },
      lightBlue: { base: '#56B4E9', emphasis: '#3A9ED6', onBase: '#FFFFFF', surface: '#E3F2FD', onSurface: '#1A4F6E', border: '#9DD4F4' },
  ...
  dark: {
    ...
    tones: {
      ...
      purple: { base: '#6E7BFF', emphasis: '#4F5AE6', onBase: '#0F132A', surface: '#232C59', onSurface: '#BFC6FF', border: '#4F5AE6' },
      blue: { base: '#5B8EFF', emphasis: '#396BDD', onBase: '#071226', surface: '#1A2E5E', onSurface: '#9EC2FF', border: '#396BDD' },
      pink: { base: '#E879F9', emphasis: '#D946EF', onBase: '#2D0635', surface: '#3B1046', onSurface: '#F3C5FA', border: '#D946EF' },
      lightBlue: { base: '#79C3F0', emphasis: '#4FA7DD', onBase: '#07111D', surface: '#162A3B', onSurface: '#BFE7FB', border: '#4FA7DD' },
